...
// NAV functions
unsigned nav_change_dir(char *target);	// Change the current directory
Directory *nav_get_dir();		// Returns Directory object representing current dir
...
// DIR functions
unsigned dir_create(char *name, Directory *dir);	// Create a new dir within a dir struct
...
void dir_list(Directory *dir);		// List all entries contained within a dir 
